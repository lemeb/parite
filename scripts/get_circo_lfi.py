...
lfidf.to_csv('data/investitures-LFI-sans-genre.csv')
lfidf = lfidf.set_index('code_circo')

anciendf = df.from_csv('data/investitures-lfi.csv')
...
joindf.to_csv('data/investitures-LFI-sexe-a-corriger.csv')
