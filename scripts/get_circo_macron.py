...
psdf = df.from_csv('data/p17_circo.csv').reset_index()
...
macrondf.to_csv('data/investitures-en-marche_sans-genre.csv', index_label='code_circo')


# Comparons avec l'ancien...
anciendf = df.from_csv('data/investitures-en-marche.csv')
...
print("Diff: " + str(joindf.loc[joindf['Same']== False].count()['Same']))
...
joindf.to_csv('data/investitures-en-marche-sexe-a-corriger.csv')
